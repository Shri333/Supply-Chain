    ...
    RetailerRole
{
    ...
    struct Item {
        ...
        address _ownerID; // Metamask-Ethereum address of the current _owner as the product moves through 8 stages
    ...
    function buyItem(uint256 _upc)
        ...
        onlyDistributor
    {
        // Update the appropriate fields - _ownerID, distributorID, itemState
        Item storage item = items[_upc];
        item._ownerID = msg.sender;
    ...
    function receiveItem(uint256 _upc)
        ...
        onlyRetailer
    {
        // Update the appropriate fields - _ownerID, retailerID, itemState
        Item storage item = items[_upc];
        item._ownerID = msg.sender;
    ...
    function purchaseItem(uint256 _upc)
        ...
        onlyConsumer
    {
        // Update the appropriate fields - _ownerID, consumerID, itemState
        Item storage item = items[_upc];
        item._ownerID = msg.sender;
